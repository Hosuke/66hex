...
e.style.setProperty ? (r = r || null, e.style.setProperty(t, n, r)) : typeof e.style.cssText != "undefined" && (r = r ? "!" + r : "", e.style.cssText += ";" + t + ":" + n + r + ";");
}
...
var s = 100, o = i.getAttribute("data-ratio") * 1;
if (!o) setProperty(i, "visibility", "hidden", "important"); else {
var u = i.getAttribute("data-w") * 1 || imgMaxW;
typeof o == "number" && o > 0 ? (u = u <= imgMaxW ? u : imgMaxW, s = u * o, setProperty(i, "width", u + "px", "important"), setProperty(i, "visibility", "visible", "important"), i.setAttribute("src", "http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHianTpT5NjcxRyqOdPZ49QtN2F4lUOibezlT1JzzjDCtAtDynZuPTXzEm8XReKPy6HQCk/0")) : setProperty(i, "visibility", "hidden", "important");
}
setProperty(i, "height", s + "px", "important"), images.push({
el: i,
